...
{
//    return [NSURL URLWithString:[NSHomeDirectory() stringByAppendingString:@"/Library"]];
    NSURL*url= [[[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:GROUP_NAME] URLByAppendingPathComponent:@"seafile" isDirectory:true];
    return url;
